    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <p class="text-gray-600 mb-6">Pilih menu di bawah ini untuk mengelola aktivitas magang industri Anda.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <a href="{{ route('siswa.jurnal.index') }}" class="block p-8 bg-white border-2 border-gray-200 rounded-xl shadow-sm hover:border-indigo-500 hover:shadow-md transition text-center">
                        <h5 class="text-xl font-bold tracking-tight text-gray-900">📝 Jurnal Kegiatan Harian</h5>
                        <p class="font-normal text-gray-600 mt-2">Isi jurnal aktivitas harian Anda di sini dan lihat feedback dari instruktur.</p>
                    </a>
                    <a href="{{ route('siswa.dokumen.index') }}" class="block p-8 bg-white border-2 border-gray-200 rounded-xl shadow-sm hover:border-indigo-500 hover:shadow-md transition text-center">
